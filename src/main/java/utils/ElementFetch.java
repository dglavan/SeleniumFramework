...
public class ElementFetch {
    ...
    public WebElement getWebElement(String identifierType, String identifierValue){
        switch (identifierType){
            ...
            case "TAGNAME": return BaseTest.driver.findElement(By.tagName(identifierValue));
            ...
            case "PARTIALLINKTEXT": return BaseTest.driver.findElement(By.partialLinkText(identifierValue));
            default: return null;
        }
    }
    ...
    public List<WebElement> getWebElements(String identifierType, String identifierValue){
        switch (identifierType){
            ...
            case "TAGNAME": return BaseTest.driver.findElements(By.tagName(identifierValue));
            ...
            case "PARTIALLINKTEXT": return BaseTest.driver.findElements(By.partialLinkText(identifierValue));
            default: return null;
        }
    }
